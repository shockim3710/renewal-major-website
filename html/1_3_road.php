...
var cityhall = new naver.maps.LatLng(35.14595233775946, 129.0361715497984),
    ...
    marker = new naver.maps.Marker({
        map: map,
        position: cityhall,
        //animation: naver.maps.Animation.BOUNCE //통통이
    });

var contentString = [
    '<div class="iw_inner">',
        '   <h3>　　정보공학관 9층　　</h3>',
        '       <a href="https://map.naver.com/v5/directions/-/14364299.047463533,4183748.9615056273,%EB%8F%99%EC%9D%98%EB%8C%80%ED%95%99%EA%B5%90%20%EA%B0%80%EC%95%BC%EC%BA%A0%ED%8D%BC%EC%8A%A4%EC%A0%95%EB%B3%B4%EA%B3%B5%ED%95%99%EA%B4%80,16797565,PLACE_POI/-/transit?c=14363581.7615377,4183256.4329482,15,0,0,0,dh" target="_blank">　　　길찾기 안내　　　</a>',
        '</div>'
    ].join('');
