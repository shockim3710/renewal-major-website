                ...
                <div class="prof_list">
                    ...
                    <div class="prof_box"> <img src="/img/professor/2.gif" alt="권오준 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./ojkwon.html');">교수실적소개</a></li>
                    ...
                    <div class="prof_box"> <img src="/img/professor/3.gif" alt="권순각 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./skkwon.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/4.gif" alt="김성우 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./libero.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/5.gif" alt="이중화 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./junghwa.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/7.gif" alt="박유현 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./yhpark.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/8.jpg" alt="임영호 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./yhleem.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/9.gif" alt="장희숙 교수">
                        <ul>
                            ...
                            <li class="profhomeButton" id="btn"><a href="javascript:prof_info('./jang1052.html');">교수실적소개</a></li>
                        </ul>
                    </div>
                </div>
        </div>
