...
그리고 끊임없이 공부하고 스스로 자기 개발을 하고, 변화에 민감하게 반응해서 새로운 상황과 환경에도 잘 적응할 수 있는 사고의 유연함을 기르는 것도 중요한 것 같습니다.</p>
          ...
          <div id = "modal10" class="modal">
			...
			<p style="margin-left: 15px;font-size: medium;margin-top: 30px;">가장 힘들게 준비한 부분은 알고리즘과 트랜드를 따라가기 위한 지속적인 공부였습니다.<br></br> 지금 재직중인 후배분들이라면 공채를 준비하실껀데 코딩 외에 다른과목들이 실무에 사용되지 않을 것 이라고 생각할수도 있지만, 기본 지식의 유무는 아주 큰 차이를 만드는 것 같습니다. 그래서 학교 수업도 열심히 듣고 마음이 맞는 사람과 작은 프로젝트부터 시작하여 차차 성쟁하나가는 것을 추천드립니다. 만약 중견/대 기업에 취업을 못하시더라도 괜찮은 중소기업도 많으니 실무경력을 쌓는 것을 추천하며, 개발쪽은 신입보다 경력직 이직이 활발하니 이점도 활용하시면 좋을 것 같아요.</p>
                    </div>
                </div>
            </div>
