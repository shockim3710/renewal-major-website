...
<div class="contents-wrapper">
    ...
    <div class="contents">
        ...
        <div class="normaltext">
         ...
         <thead>
            <tr>
               <th onclick="changeIframeUrl('barchart.php')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">년도</th>
               <th>졸업생</th>
               <th>진학자</th>
               <th>입대자</th>
               <th>취업률대상</th>
         ...
         <tbody>
            <tr>
               <td onclick="changeIframeUrl('piechart2020.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2020년도</td>
               <td>42</td>
               <td>1</td>
               <td>0</td>
               <td>41</td>
            ...
            <tr>
                <td onclick="changeIframeUrl('piechart2019.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2019년도</td>
               <td>50</td>
               <td>0</td>
               <td>0</td>
               <td>50</td>
            ...
            <tr>
                <td onclick="changeIframeUrl('piechart2018.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2018년도</td>
               <td>38</td>
               <td>1</td>
               <td>1</td>
               <td>36</td>
            ...
            <tr>
                <td onclick="changeIframeUrl('piechart2017.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2017년도</td>
               <td>45</td>
               <td>1</td>
               <td>0</td>
               <td>44</td>
            ...
            <tr>
                <td onclick="changeIframeUrl('piechart2016.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2016년도</td>
               <td>61</td>
               <td>0</td>
               <td>0</td>
               <td>61</td>
            ...
            <tr>
                <td onclick="changeIframeUrl('piechart2015.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2015년도</td>
               <td>63</td>
               <td>3</td>
               <td>0</td>
               <td>60</td>
            ...
            <td onclick="changeIframeUrl('piechart2014.html')"
                    onMouseOver="this.style.border='3px solid #602320'"
                    onMouseOut="this.style.borderBottom='1px solid #DCDCDC',
                                this.style.borderLeft='1px solid #DCDCDC',
                                this.style.borderRight='0px solid #DCDCDC',
                                this.style.borderTop='0px solid #DCDCDC'">2014년도</td>
               <td>40</td>
               <td>2</td>
               <td>0</td>
               <td>38</td>
          ...
          <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※ 연도를 클릭하면 해당 연도 그래프가 표시됩니다.</div>
      </div>
...
<html>
    ...
    <body>
    <p align="middle">
    <iframe align="center" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling = "no" name="main_frame" id="main_frame" src="barchart.php" title="테스트" width="600px" height="450px"></iframe>
    </p>
    </body>
</html>
            ...
            <div class = "row" >
                ...
                <div class="flip-card">
                    <button type="button" id="btn11" class="btn11 hbutton">
                        <img src="./logoimg/NHN1.png" style="height:35%;width:80%;margin-top: 0px;"><p style="font-weight: bold;"><br/>2016년 졸업생 김O훈</p>
                    </button>
                </div>    
...
그리고 끊임없이 공부하고 스스로 자기 개발을 하고, 변화에 민감하게 반응해서 새로운 상황과 환경에도 잘 적응할 수 있는 사고의 유연함을 기르는 것도 중요한 것 같습니다.</p>
          ...
          <div id = "modal10" class="modal">
            ...
            <div id = "modal11" class="modal">
                <div class="modal-content">
                    <div class="headcon">
                        <p class = "headtitle">NHN 엔터테이먼트</p>
                        <span class="close">&times;</span>
                    </div>
                    <div class="titlecon">
                        <div class="titlelogo">
                            <img src="./logoimg/NHN1.png" style="width:70%;margin-top: 10px;margin-left: 30px;">
                        </div>
                        <div class="titletext">
                            <p style="font-size:x-large;color: dodgerblue;font-weight: bold;">2016년 졸업생 김O훈</p>
                            <p  style="font-size:medium"><br/>NHN 소프트 개발자</p>
                        </div>
                    </div>
                    <div class="vertical-line"></div>
                    <div class="con">
                        <p style="font-size: large;margin-left: 20px;margin-top: 30px;color: dodgerblue;">Q. 졸업생 선배로서 후배들에게 한마디</p>
         <p style="margin-left: 15px;font-size: medium;margin-top: 30px;">가장 힘들게 준비한 부분은 알고리즘과 트랜드를 따라가기 위한 지속적인 공부였습니다.<br></br> 지금 재직중인 후배분들이라면 공채를 준비하실껀데 코딩 외에 다른 과목들이 실무에 사용되지 않을 것 이라고 생각할수도 있지만, 기본 지식의 유무는 아주 큰 차이를 만드는 것 같습니다. 그래서 학교 수업도 열심히 듣고 마음이 맞는 사람과 작은 프로젝트부터 시작하여 경험을 쌓는 것을 추천드립니다. 만약 중견/대 기업에 취업을 못하더라도 괜찮은 중소기업도 많으니 실무경력을 쌓는 것을 추천하며, 개발쪽은 신입보다 경력직 이직이 활발하니 이점도 활용하시면 좋을 것 같아요.</p>
                    </div>
                </div>
            </div>
