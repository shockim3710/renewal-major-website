        ...
        <div class="bodytitle">
            ...
            <ul class="accordion">
                <li class="accordion-item">
                    ...
                    <label for="s1"class="accordion-label">공학인증(KCC2015)- 2013년 평가부터 적용</label>
                    <div class="accordion-child"><iframe src="/js/pdfjs/web/viewer.html?file=KCC2015인증기준.pdf" style="width:100%; height:600px;border:none;"></iframe></div>
                </li>
                </ul>        
        </div>
    </div>
