...
<div id="menulist" class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?> menu_list menu_group_<?php echo substr($row['me_code'], 0, 2); ?>">
        ...
        <td class="td_num">
            <label for="me_code_<?php echo $i; ?>" class="sound_only">메뉴코드</label>
            <input type="text" value="<?php echo $row['me_code'] ?>" id="me_code_<?php echo $i; ?>" class="frm_input" size="5" disabled>
        </td>
        <td class="td_mng">
