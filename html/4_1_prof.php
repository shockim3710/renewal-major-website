                ...
                <div class="prof_list">
                    ...
                    <div class="prof_box"> <img src="/img/professor/3.gif" alt="권순각 교수">
                        <ul>
                            ...
                            <!-- <a href="http://113.198.234.149/front/phtml/professor3/" target="_blank"><li class="profhomeButton">교수홈페이지</li></a> -->
                            <a href="https://se.deu.ac.kr/front/template/html/professor3/index.html" target="_blank"><li class="profhomeButton">교수홈페이지</li></a>
                        </ul>
                    </div>
                    ...
                    <div class="prof_box"> <img src="/img/professor/6.gif" alt="이종민 교수">
                        <ul>
                            ...
                            <a href="https://compnet.deu.ac.kr/homepage2/index.html" target="_blank"><li class="profhomeButton">교수홈페이지</li></a>
                        </ul>
                    </div>
