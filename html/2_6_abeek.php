        ...
        <div class="contents-body">
            ...
            <ul class="accordion">
                <li class="accordion-item">
                    ...
                    <label for="s1"class="accordion-label">컴퓨터소프트웨어공학과 교과목이수체계도</label>
                    <div class="accordion-child"><iframe src="/js/pdfjs/web/viewer.html?file=2020교과목이수체계도.pdf" style="width:100%; height:600px;border:none;"></iframe></div>
                </li>
            </ul>        
        </div>
    </div>
